...
function PostUploader() {
    ...
    return (
        ...
        <>
            <Sidebar />
            <div className="max-w-md w-full mx-auto mt-10 bg-white border border-gray-200 rounded-3xl shadow-lg overflow-hidden max-sm:mb-9 max-sm:overflow-y-scroll transition-all">
                <div className="p-6">
